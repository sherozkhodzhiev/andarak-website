...
export default function HistoryPage({ initialLang = "en" }) {
  const [lang, setLang] = useState(initialLang === "ru" ? "ru" : "en");
  ...
  return (
    <div className="relative" style={{ background: "var(--ink)", color: "var(--parchment)" }} data-testid="andarak-app">
      ...
      <Link
        to="/"
        className="fixed bottom-5 left-5 z-[95] font-mono-d text-[10px] tracking-[.14em] uppercase px-3.5 py-2"
        style={{
          color: "var(--parchment-dim)",
          background: "rgba(20,17,15,.6)",
          border: "1px solid rgba(237,227,208,.22)",
          backdropFilter: "blur(10px)",
          WebkitBackdropFilter: "blur(10px)",
        }}
        data-testid="exit-to-portal"
      >
        {T.backToPortal[lang]}
      </Link>
